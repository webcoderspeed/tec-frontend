...
export const USER_FOLLOWING_LIST_RESET = 'USER_FOLLOWING_LIST_RESET';

export const USER_FOLLOWER_LIST_REQUEST = 'USER_FOLLOWER_LIST_REQUEST';
export const USER_FOLLOWER_LIST_SUCCESS = 'USER_FOLLOWER_LIST_SUCCESS';
export const USER_FOLLOWER_LIST_FAIL = 'USER_FOLLOWER_LIST_FAIL';
export const USER_FOLLOWER_LIST_RESET = 'USER_FOLLOWER_LIST_RESET';

export const USER_LOGIN_WITH_SOCIAL_REQUEST = 'USER_LOGIN_WITH_SOCIAL_REQUEST';
export const USER_LOGIN_WITH_SOCIAL_SUCCESS = 'USER_LOGIN_WITH_SOCIAL_SUCCESS';
export const USER_LOGIN_WITH_SOCIAL_FAIL = 'USER_LOGIN_WITH_SOCIAL_FAIL';
export const USER_LOGOUT_WITH_SOCIAL = 'USER_LOGOUT_WITH_SOCIAL';
